...
class PetFriends:
    """библиотека API Pet Friends"""

    def __init__(self):
        self.base_url = "https://petfriends1.skillfactory.ru/"

    def get_api_key(self, email: 'luda_deo@mail.ru', password: 'smoke11') -> json:
        """Метод делает запрос к API сервера и возвращает статус запроса и результат в формате
        JSON с уникальным ключем пользователя, найденного по указанным email и паролем"""

        headers = {
            'email': 'luda_deo@mail.ru',
            'password': 'smoke11',
        }
